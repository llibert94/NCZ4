...
#if !defined(BLACKBRANEADS_HPP_)
#error "This file should only be included through BlackBraneAdS.hpp"
#endif

#ifndef BLACKBRANEADS_IMPL_HPP_
#define BLACKBRANEADS_IMPL_HPP_
...
void BlackBraneAdS<background_t>::compute(Cell<data_t> current_cell) const
{
...
template <class background_t>
template <class data_t>
void BlackBraneAdS<background_t>::compute_kerr(Tensor<2, data_t> &spherical_g,
                                        Tensor<2, data_t> &spherical_K,
                                        Tensor<1, data_t> &spherical_shift,
                                        data_t &kerr_lapse,
