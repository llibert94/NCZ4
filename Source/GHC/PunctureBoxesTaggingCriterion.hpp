...
#ifndef PUNCTUREBOXESTAGGINGCRITERION_HPP_
#define PUNCTUREBOXESTAGGINGCRITERION_HPP_
...
class PunctureBoxesTaggingCriterion
{
  protected:
    const double m_dx;
    const int m_level;
...
#endif /* PUNCTUREBOXESTAGGINGCRITERION_HPP_ */
