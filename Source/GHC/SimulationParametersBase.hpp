...
class SimulationParametersBase : public ChomboParameters
{
  ...
  private:
    ...
    {
        // Lapse evolution
        pp.load("lapse_advec_coeff", ghc_params.lapse_advec_coeff, 1.0);
        ...
        ghc_params.kappa1 = ghc_base_params.kappa1;
        ghc_params.kappa2 = ghc_base_params.kappa2;
        ghc_params.covariantZ4 = ghc_base_params.covariantZ4;
    ...
    void check_params()
    {
        ...
        warn_parameter("lapse_advec_coeff", ghc_params.lapse_advec_coeff,
                       min(abs(ghc_params.lapse_advec_coeff),
                           abs(ghc_params.lapse_advec_coeff - 1.0)) <
                           std::numeric_limits<double>::epsilon(),
                       "usually set to 0.0 or 1.0");
        warn_parameter("lapse_power", ghc_params.lapse_power,
                       abs(ghc_params.lapse_power - 1.0) <
                           std::numeric_limits<double>::epsilon(),
                       "set to 1.0 for 1+log slicing");
        warn_parameter("lapse_coeff", ghc_params.lapse_coeff,
                       abs(ghc_params.lapse_coeff - 2.0) <
                           std::numeric_limits<double>::epsilon(),
                       "set to 2.0 for 1+log slicing");
        warn_parameter("shift_Gamma_coeff", ghc_params.shift_Gamma_coeff,
                       abs(ghc_params.shift_Gamma_coeff - 0.75) <
                           std::numeric_limits<double>::epsilon(),
                       "usually set to 0.75");
        warn_parameter("shift_advec_coeff", ghc_params.shift_advec_coeff,
                       min(abs(ghc_params.shift_advec_coeff),
                           abs(ghc_params.shift_advec_coeff - 1.0)) <
                           std::numeric_limits<double>::epsilon(),
                       "usually set to 0.0 or 1.0");
        warn_parameter("eta", ghc_params.eta,
                       ghc_params.eta > 0.1 && ghc_params.eta < 10,
  ...
  protected:
    ...
    GHC_base_params_t ghc_base_params;
