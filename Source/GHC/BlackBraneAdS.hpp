...
#ifndef BLACKBRANEADS_HPP_
#define BLACKBRANEADS_HPP_
...
template <class background_t> class BlackBraneAdS
{
  ...
  public:
    BlackBraneAdS(params_t a_params, double a_dx, background_t a_background)
...
#include "BlackBraneAdS.impl.hpp"

#endif /* BLACKBRANEADSBH_HPP_ */
