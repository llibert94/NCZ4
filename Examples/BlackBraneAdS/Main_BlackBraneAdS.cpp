...
int runGRChombo(int argc, char *argv[])
{
    ...
    BHAMR<> bh_amr;
    DefaultLevelFactory<BlackBraneAdSLevel> black_brane_ads_level_fact(bh_amr, sim_params);
    setupAMRObject(bh_amr, black_brane_ads_level_fact);
    ...
    {
        AHSurfaceGeometry sph(sim_params.black_brane_params.center);
